      ...
      <div className="rules-wrap">
        ...
        <div className="rules-section">
          ...
          <ul className="rules-list">
            ...
            <li>Every <strong style={{ color: "#d8b6ff", fontStyle: "normal" }}>5th round a witness takes the stand</strong> — a fellow clerk, guard, or merchant. Interrogate them with sharp questions to surface helpful testimony. These rounds <strong style={{ color: "#d8b6ff", fontStyle: "normal" }}>cannot be skipped</strong>, and weak questioning lets the Qazi raise suspicion.</li>
          </ul>
        </div>
